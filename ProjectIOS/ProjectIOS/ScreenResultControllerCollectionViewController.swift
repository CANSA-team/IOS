...
class ScreenResultControllerCollectionViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.result(with: data[indexPath.row],with: result[indexPath.row]) // Đây là 2 mảng 1 là tên title 2 là màng đúng sai biểu thị dưới 1 và 0,có thể cấu hình func result bên file CollectionViewCell
